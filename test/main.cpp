...
int main(int argc, char** argv)
{
  ...
  {
    std::ifstream file_in("test/data/" + test + ".b", std::ios::binary);
    if (!file_in)
    ...
    if (fs::exists("test/data/" + test + ".in"))
    {
      std::ifstream input_in("test/data/" + test + ".in", std::ios::binary);
    ...
    {
      std::ifstream reference_in("test/data/" + test + ".out");
      if (reference_in)
